                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-gradient-success p-3">
                            <h5 class="text-white mb-0">Riwayat Export</h5>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            <th class="text-uppercase text-xs font-weight-bolder opacity-7">Tanggal</th>
                                            <th class="text-uppercase text-xs font-weight-bolder opacity-7">Nama File</th>
                                            <th class="text-uppercase text-xs font-weight-bolder opacity-7">Format</th>
                                            <th class="text-uppercase text-xs font-weight-bolder opacity-7">Ukuran</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="ps-3">
                                                <p class="mb-0 text-sm">20 Jun 2023</p>
                                                <p class="text-xs text-secondary mb-0">14:30</p>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">Laporan_Kelulusan_2023</p>
                                            </td>
                                            <td>
                                                <span class="badge bg-gradient-success">Excel</span>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">256 KB</p>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="ps-3">
                                                <p class="mb-0 text-sm">15 Jun 2023</p>
                                                <p class="text-xs text-secondary mb-0">09:15</p>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">Data_Siswa_Lulus_2023</p>
                                            </td>
                                            <td>
                                                <span class="badge bg-gradient-primary">PDF</span>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">512 KB</p>
                                            </td>
                                            <td>
                                                <button class="btn btn-link text-primary mb-0">
                                                    <i class="material-icons text-sm">download</i>
                                        ...
                                        <tr>
                                            <td class="ps-3">
                                                <p class="mb-0 text-sm">10 Jun 2023</p>
                                                <p class="text-xs text-secondary mb-0">11:45</p>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">Hasil_Prediksi_Batch_1</p>
                                            </td>
                                            <td>
                                                <span class="badge bg-gradient-info">CSV</span>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">128 KB</p>
                                            </td>
                                            <td>
                                                <button class="btn btn-link text-primary mb-0">
                                                    <i class="material-icons text-sm">download</i>
